...
description: Create your first Minecraft profile in VelGrinor
---

# Your First Profile

A profile in VelGrinor is a complete Minecraft setup: a version, optional mod loader, and your selected mods, resource packs, and shaders.
...
VelGrinor includes templates for common setups:
...
velgrinor profile create "My Profile" --version 1.21.4

# Create a Fabric profile
velgrinor profile create "Modded" --version 1.21.4 --loader fabric
```
