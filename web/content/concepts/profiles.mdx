---
title: Profiles
description: Understanding VelGrinor profile manifests
---

# Profiles

VelGrinor is built around a few key concepts that make it different from other launchers. The flow is:
...
Profiles are stored in `~/.velgrinor/profiles/<profile-id>/`:
...
```bash
velgrinor profile clone "Original" "New Profile"
```
...
# Create a profile
velgrinor profile create "Name" --mc 1.21.4 --loader fabric

# Delete a profile
velgrinor profile delete "Name"

# Show profile details
velgrinor profile show "Name"
```
