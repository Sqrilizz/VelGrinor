...
export type Config = {
  ...
  minimize_on_game_start?: boolean;
  restore_on_game_exit?: boolean;
  automatic_snapshot_retention?: number;
};
...
// Library types
export type LibraryContentType = "mod" | "modpack" | "resourcepack" | "shaderpack" | "skin";
