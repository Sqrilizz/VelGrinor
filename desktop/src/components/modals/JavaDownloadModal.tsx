...
export function JavaDownloadModal({ open, onClose, javaMajor, mcVersion, onSuccess }: JavaDownloadModalProps) {
  ...
  return (
    <Modal open={open} onClose={handleClose} title={t("Java Required")}>
      <div className="java-download-modal">
        ...
        {stage === "confirm" && (
          <>
            <p className="java-download-desc">{t("Minecraft")} {mcVersion}{t("requires")} <strong>{t("Java")} {javaMajor}</strong>{t("which is not installed on your system.")}
            </p>
            <p className="java-download-desc">{t("Would you like to download and install it automatically from Eclipse Adoptium (Temurin)?")}
            </p>

            {releaseInfo && (
              <div className="java-download-info">
                <div className="java-download-info-row">
                  <span className="java-download-info-label">{t("Version")}</span>
                  <span className="java-download-info-value">{releaseInfo.version}</span>
                </div>
                <div className="java-download-info-row">
                  <span className="java-download-info-label">{t("Size")}</span>
            ...
            <div className="java-download-actions">
              <button className="btn btn-secondary" onClick={onClose}>{t("Cancel")}
              </button>
              <button
        ...
        {stage === "downloading" && (
          <>
            <p className="java-download-desc">{t("Downloading Java")} {javaMajor}...
            </p>
            ...
            <p className="java-download-hint">{t("Please wait, this may take a few minutes...")}
            </p>
          </>
        )}
        ...
        {stage === "extracting" && (
          <>
            <p className="java-download-desc">{t("Extracting Java")} {javaMajor}...
            </p>
        ...
        {stage === "done" && (
          <>
            <div className="java-download-success">
              ...
              <p>{t("Java")} {javaMajor}{t("installed successfully!")}</p>
            </div>
          </>
        )}
      </div>
