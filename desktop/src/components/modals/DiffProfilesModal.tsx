...
export function DiffProfilesModal({ open, onClose }: DiffProfilesModalProps) {
  ...
  return (
    <Modal open={open} onClose={onClose} title={t("Compare profiles")} large>
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <button className="btn btn-primary" onClick={handleCompare}>{t("Compare")}</button>
        {result && (
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16, marginTop: 8 }}>
            <div>
              <div className="field-label">{t("Only in A")}</div>
            ...
            <div>
              <div className="field-label">{t("Only in B")}</div>
            ...
            <div>
              <div className="field-label">{t("In both")}</div>
