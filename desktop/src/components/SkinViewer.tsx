...
export function SkinViewer({
  ...
  useEffect(() => {
    ...
    const pixelRatioLimit = navigator.userAgent.includes("Linux") ? 1 : 1.5;
    ...
    const animate = () => {
      animationId = null;
      if (document.visibilityState !== "visible" || !isIntersecting) return;
    ...
    const startRendering = () => {
      if (animationId !== null || frameTimer !== null) return;
      clock.start();
      animationId = requestAnimationFrame(animate);
    };
